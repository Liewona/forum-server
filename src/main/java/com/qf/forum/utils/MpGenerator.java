...
//        assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        gc.setAuthor("FPF");
        gc.setOutputDir("C:\\Users\\付爸爸\\Desktop\\forum-server\\src\\main\\java"); //对应项目的src/main/java目录在磁盘上的真实路径
        ...
        dsc.setUrl("jdbc:mysql://124.71.162.78:3306/db_forum?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false");
        ...
        pc.setParent("com.qf.forum.proj"); //项目的根包（启动类所在的包）
